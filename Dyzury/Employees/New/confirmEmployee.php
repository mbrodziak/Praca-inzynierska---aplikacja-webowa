				...
				{								
					if (isset($_SESSION['ready']))
					{
						...
						'$admin2', '0000-00-00 00:00:00')"))
						{
							...
							header('Location: /Dyzury/Employees/New/addedEmployee.php');
						}
						else
						{
...
<body>
	...
	<div class="container">
		...
		<div class="no_name_yet">
			...
			<div class="cancel"><a href="/Dyzury/Employees/New/newEmployee.php"><input type="submit" class"cancel" value="ANULUJ" /></a></div>
