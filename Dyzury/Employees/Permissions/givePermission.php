			...
			if(isset($_POST['employees']))
			{
				...
				if(!empty($password))
				{
					...
					else
					{
						...
						{
							if($connection->query("UPDATE pracownicy set admin = '1' where login = '$employees[$i]'"))
							{
	...
	<div class="container">
		<div class="row">
			<div class="col">
				...
				<a href="/Employees/cadre.php" class="btn btn-primary" role="button" id="cancelGive">ANULUJ</a>
