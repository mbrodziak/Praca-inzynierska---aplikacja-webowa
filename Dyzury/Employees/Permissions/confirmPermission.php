			...
			if(isset($_POST['password']))
			{
				...
				{	 
					if(isset($_SESSION['givePermission']))
					{
						...
						header('Location: /Employees/Permissions/givedPermission.php');
					}
					...
					if(isset($_SESSION['receivePermission']))
					{
						...
						unset($_SESSION['empA']);
						header('Location: /Employees/Permissions/receivedPermission.php');
					}					
				}
			}	
			$connection->close();
...
<body>
	...
	<div class="container">
		...
		<div class="no_name_yet">
			...
			if(isset($_SESSION['givePermission']))
			{
				echo "/Employees/Permissions/givePermission.php";
				unset ($_SESSION['givePermission']);
			}
